...
target("bedrock")
    ...
    add_ldflags("/INCREMENTAL:NO /OPT:REF /OPT:ICF")
    add_cxflags("/O2 /DNDEBUG /Zi /Gy")
...
target("endstone_python")
    ...
    add_ldflags("/INCREMENTAL:NO /OPT:REF /OPT:ICF")
    add_cxflags("/utf-8 /O2 /DNDEBUG /Zi /Gy")
    add_defines("PYBIND11_DETAILED_ERROR_MESSAGES", "NDEBUG")
    add_deps("endstone")
...
target("endstone_runtime")
    ...
    add_includedirs("src/")
    add_ldflags("/INCREMENTAL:NO /OPT:REF /OPT:ICF /EXPORT:DllMain,@1,NONAME")
    add_cxflags("/utf-8 /O2 /DNDEBUG /Zi /Gy")

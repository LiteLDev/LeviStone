...
target("endstone_runtime")
    ...
    remove_files("endstone/src/endstone/runtime/bedrock_hooks/map_data_manager.cpp")
    remove_files("endstone/src/endstone/runtime/bedrock_hooks/nethernet_transport.cpp")
    remove_files("endstone/src/endstone/runtime/bedrock_hooks/port.cpp")

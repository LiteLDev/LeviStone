...
#ifdef _WIN32
std::unique_ptr<::MapItemSavedData> MapDataManager::_deserializeMapData(const ActorUniqueID &uuid)
{
    auto map_data = ENDSTONE_HOOK_CALL_ORIGINAL(&MapDataManager::_deserializeMapData, this, uuid);
    if (map_data) {
